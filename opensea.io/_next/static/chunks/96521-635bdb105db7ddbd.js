        ...
        6222: function(n, e, t) {
            ...
            var i = t(19989),
                ...
                W = function(n) {
                    var e, i = n.data,
                        ...
                        d = void 0 === l ? "button" : l,
                        W = (0, y.q)("components"),
                        B = (0, u.useFragment)(t(32177), i),
                        F = (0, m.Fg)().theme,
                        O = (0, k.P)(),
                        S = (0, o.useState)(!1),
                        A = S[0],
                        E = S[1],
                        U = (0, s.Z)((0, C.i)(t(81214), {
                            collection: a
                        }), 1)[0];
                    (0, o.useEffect)((function() {
                        var n;
                        E(!!(null === U || void 0 === U || null === (n = U.collection) || void 0 === n ? void 0 : n.isWatching))
                    }), [null === U || void 0 === U || null === (e = U.collection) || void 0 === e ? void 0 : e.isWatching]);
                    var D = (0, w.b)(),
                        P = D.wallet,
                        L = D.mutate,
                        R = D.updateContext,
                        _ = (0, I.e)(),
                        V = _.attempt,
                        z = _.showSuccessMessage,
                        q = P.getActiveAccountKey(),
                        M = A ? W("collections.watchlistButton.watching", "Watching") : W("collections.watchlistButton.add", "Add to watchlist"),
                        K = function() {
                            var n = (0, c.Z)(h().mark((function n() {
                                return h().wrap((function(n) {
                                    for (;;) switch (n.prev = n.next) {
                                        ...
                                        case 4:
                                            return n.next = 6, V((0, c.Z)(h().mark((function n() {
                                                var e;
                                                return h().wrap((function(n) {
                                                    for (;;) switch (n.prev = n.next) {
                                                        case 0:
                                                            return n.next = 3, L(t(57556), {
                                                                collectionId: null !== (e = null === B || void 0 === B ? void 0 : B.relayId) && void 0 !== e ? e : "",
                                                                isWatching: !A
                                                            }, {
                                                                shouldAuthenticate: !0,
                                                                updater: function(n) {
                                                                    if (null === B || void 0 === B ? void 0 : B.relayId) {
                                                                        var e = n.get(B.relayId);
                                                                        e && e.setValue(!A, "isWatching")
                                                                    }
                                                                }
                                                            });
                                                        case 3:
                                                            n.sent.collections.updateWatchlist && (A ? (0, T.gM)({
                                                                collectionSlug: a
                                                            }) : (0, T.wd)({
                                                                collectionSlug: a
                                                            }), z((0, r.jsxs)(p.k, {
                                                                children: [A ? W("collections.watchlistButton.removeSuccess", "Removed from watchlist.") : W("collections.watchlistButton.addSuccess", "Added to watchlist."), (0, r.jsx)(f.g, {
                                                                    marginLeft: "8px",
                                                                    children: (0, r.jsx)(g.r, {
                                                                        href: O,
                                                                        children: W("collections.watchlistButton.cta", "View")
                                                                    })
                                                                })]
                                                            })), E(!A));
                                                        case 5:
                        ...
                        $ = "light" === F ? Z.r7.charcoal : Z.r7.fog;
                    return "option" === d ? (0, r.jsxs)(v.ck, {
                        ...
                        content: A ? W("collections.watchlistButton.watchingTooltip", "Watching") : W("collections.watchlistButton.addTooltip", "Add to watchlist"),
                        hideOnClick: !0,
                        children: (0, r.jsx)(j.h, {
                            "aria-label": A ? W("collections.watchlistButton.watchingLabel", "Watching") : W("collections.watchlistButton.addLabel", "Add to watchlist"),
            ...
            var X = function(n) {
                    var e = n.collectionWatchlistDataKey,
                        ...
                        B = (0, U.Fg)().theme,
                        J = (0, w.b)().isStaff,
                        H = (0, a.Z)("(min-width: ".concat(P.AV.lg, "px)"), !0),
                        Q = (0, a.Z)("(min-width: ".concat(P.AV.md, "px)"), !0),
                        X = "light" === B ? "oil" : "fog",
                        en = (0, K.g1)(h);
        ...
        89824: function(n, e, t) {
            ...
            var T = function(n) {
                ...
                Z = (0, a.ZP)(l.E).withConfig({
                    componentId: "sc-85d02b22-0"
                })(k()),
                W = (0, a.ZP)(d.r).withConfig({
                    componentId: "sc-85d02b22-1"
                })(w(), (function(n) {
                    return n.theme.colors.text.subtle
                }), (function(n) {
                    return n.theme.colors.text.body
                })),
                B = (0, a.ZP)(f.WX).withConfig({
                    componentId: "sc-85d02b22-2"
                })(C(), (function(n) {
                ...
                F = (0, a.ZP)(h.W).withConfig({
                    componentId: "sc-85d02b22-3"
                })(I(), (0, v.Um)({
                    variants: {
                        dark: {
                            filter: "brightness(3)"
...
//# sourceMappingURL=96521-635bdb105db7ddbd.js.map